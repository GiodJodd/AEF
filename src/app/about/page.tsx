            ...
            <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-12 md:gap-16 mb-24">
              <div className="space-y-6 text-base md:text-lg text-white/50 leading-relaxed font-light">
                ...
                <p>
                  ...
                  AEF aims not only to produce films, but to construct an
                  ecosystem in which the value generated by a work is more
                  equitably shared and where cinema can continue to evolve as
                  both an art form and a living industry.
                </p>
              </div>
